        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6 lg:p-8">
                <form id="product-form" action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <!-- Ürün Fotoğrafı -->
                    <div class="mb-4">
                        <x-label for="image" :value="__('Ürün Fotoğrafı')" />
                    ...
                    <div class="mb-4">
                        ...
                        <x-input id="calories" class="block mt-1 w-full" type="number" step="0.01" name="calories" :value="old('calories')" required />
